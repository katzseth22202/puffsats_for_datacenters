...
A large deployment rocket carries the PuffSats through the Jupiter flyby and releases them only during the final approach to Earth. Until then, it supplies their power and maintains their water supply in liquid form.

Juno demonstrated that solar panels can keep craft warm at Jupiter~\cite{bolton2017juno,juno_solar_record}. A large PuffSat cargo rocket can devote a smaller fraction of its mass to thermal management than Juno because surface area scales more slowly than volume. A battery provides thermal regulation during the rocket's brief passage through Jupiter's shadow.

The rocket's flyby trajectory crosses the damaging equatorial radiation belts that Juno's polar orbit was designed to avoid~\cite{bolton2017juno,katz2026aim}. The volatile mass of the PuffSats serves as shielding, surrounding sensitive electronics with \qtyrange{50}{100}{\centi\meter} of low-$Z$ material. High-energy electrons and their associated bremsstrahlung radiation are the dominant radiation hazard~\cite{roussos2021jovian_belts,katz2026aim}. The hydrogen within the PuffSat mass moderates secondary neutrons knocked out of atomic nuclei by energetic protons and photons, while boron carbide incorporated at approximately \SI{0.5}{\percent} by mass captures these thermalized neutrons~\cite{katz2026aim}.

Photovoltaics may not survive unshielded passage through Jupiter's radiation belts. Instead, concentrating mirrors or lenses directly heat the rocket's exterior and redirect sunlight through mirrored cavities to protected solar cells~\cite{winston2005nonimaging}. Even with an angular pointing error of \ang{1}, the focused light remains within roughly \ang{5} of its central axis~\cite{winston2005nonimaging,katz2026aim}. This narrow beam enters an aperture in the shield and undergoes two reflections to reach the internal photovoltaics (\autoref{fig:mirrored_light_cavity}).

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{mirrored_light_cavity.pdf}
    \caption{A payload at Jupiter, shown in cross-section (not to scale). Incident sunlight enters from above. The left concentrating mirror focuses light onto an absorber to warm the payload, while the right mirror directs light to a secondary mirror, aiming a narrow beam through a radiation-shield aperture. Internal fold mirrors ($M_1$ and $M_2$) redirect the beam through two right angles onto the PV cells. Trapped electrons and protons travel in nearly straight lines at this scale, passing through the mirrors or striking channel walls to be absorbed by the shield. The dotted line indicates that no direct line of sight exists from the aperture to the photovoltaics.}
    \label{fig:mirrored_light_cavity}
\end{figure}

The rocket deploys the PuffSats up to \SI{1.3}{\astronomicalunit} from the Sun, initiating a coast phase to Earth lasting approximately 16 days~\cite{katz2026aim}. Each PuffSat consists of an outer water envelope surrounding an inner container of explosive emulsion.  The water's convection preserves the required emulsion temperature throughout the coast. Immediately prior to release, a deployment mechanism spins and aligns each PuffSat while kneading the emulsion. Kneading incorporates sensitizers that are stored separately during flight to eliminate the risk of accidental detonation~\cite{maranda2025comprehensive}.  Slow-acting gelling agents also added during kneading fix the sensitizing bubbles in place, eliminating the need for onboard pumps.
