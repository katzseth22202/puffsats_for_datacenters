...
Large orbital data centers provide a potential near-term market for very heavy lift. Iran's 2026 strikes on terrestrial data centers~\cite{cnbc2026_aws_strike,gatech2026_aws_strike} show that data centers are military targets. China's 2007 destruction of the FY-1C weather satellite~\cite{kelso2007asat,nasa_odqn2007_fengyun,kan2007_asat} confirms that direct-ascent suborbital missiles can reach sun-synchronous orbit in minutes. In \autoref{sec:data_center_attacks}, we argue for orbits distant enough that an attack takes days to arrive, leaving time to respond. Because each cluster is co-located, only its link to Earth slows down, and AI training and long-running coding inference can tolerate the added round-trip latency of \qtyrange{2.6}{10}{\second}. Reaching them takes more $\deltav$, which favors PuffSat Pulsed Propulsion over conventional rockets. \autoref{sec:launch_cost_speculation} argues that PuffSat Pulsed Propulsion can deliver mass to these orbits for less than fully reusable rockets such as SpaceX Starship~\cite{starship}.
