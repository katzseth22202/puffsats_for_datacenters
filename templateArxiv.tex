...
\begin{abstract}
PuffSat Pulsed Propulsion is a non-nuclear kinetic analogue of Project Orion. Small, low-cost satellites (``PuffSats'') fly an Earth--Jupiter--Earth gravity-assist loop that closes in 2.2 or 3.3 years. They return on retrograde orbits at Earth-relative speeds of \qtyrange{55}{68}{\kilo\meter\per\second}. At these speeds, a PuffSat's kinetic energy per unit mass exceeds methalox's specific combustion energy by more than a hundredfold.
